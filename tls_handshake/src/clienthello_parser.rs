        ...
        if self.offset < self.data.len() {
            ...
            while self.offset < extensions_end {
                ...
                self.client_hello.extensions.push(Extension {
                    order_id: extension_count as u8,
            ...
            self.client_hello.extensions_num = extension_count as u16;
        }
    }
...
pub fn parse_client_hello(data: &[u8], enable_print: bool) -> ClientHelloParser{
    ...
    if enable_print{
        ...
        parser.get_client_hello().print_json("clienthello_parser_json".to_string());
    }
    parser.clone()
}
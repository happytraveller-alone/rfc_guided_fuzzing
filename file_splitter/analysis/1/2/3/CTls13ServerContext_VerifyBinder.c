__int64 __fastcall CTls13ServerContext::VerifyBinder(CTls13ServerContext *this,
                                                     unsigned __int8 *a2,
                                                     unsigned __int16 a3,
                                                     unsigned __int16 a4,
                                                     unsigned __int16 a5) {
  ...
  PrfHashDetails = CSessionCacheItem::GetPrfHashDetails(
      *((CSessionCacheItem **)this + 124), (unsigned __int8 *)Length, 0i64);
  if (!PrfHashDetails) {
    v11 = Length[0];
    if (Length[0] <= 0x40u) {
      if (Length[0] == v5) {
        ...
        v15 = (*(__int64(__fastcall **)(CTls13ServerContext *, _QWORD))(
            *(_QWORD *)this + 512i64))(this, 0i64);
        if (v15)
          HandshakeHash =
              SslDuplicateTranscriptHash(v14, v15, &Length[1], 0i64);
        else
          HandshakeHash = SslCreateHandshakeHash(v14, &Length[1], v18, v13, 0);
        PrfHashDetails = HandshakeHash;
        if (!HandshakeHash) {
          PrfHashDetails = SslHashHandshake(
              v14, *(_QWORD *)&Length[1], *((_QWORD *)this + 110),
              (unsigned int)(*((_DWORD *)this + 218) - v9), 0);
          if (!PrfHashDetails) {
            PrfHashDetails = CTls13Context::GenerateBinderData(
                (CTls13ServerContext *)((char *)this + 1000), v14,
                *(_QWORD *)(*((_QWORD *)this + 124) + 16i64),
                *(__int64 *)&Length[1], v18, v13,
                *(const unsigned __int8 **)(*((_QWORD *)this + 124) + 200i64),
                *(unsigned __int8 *)(*((_QWORD *)this + 124) + 208i64), Source1,
                v11);
            if (PrfHashDetails) {
              if (WPP_GLOBAL_Control != (CCipherMill *)&WPP_GLOBAL_Control &&
                  (*((_BYTE *)WPP_GLOBAL_Control + 28) & 1) != 0) {
                WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 69i64,
              ...
              *((_QWORD *)this + 17) &= ~0x8000ui64;
              ...
              CSslContext::SetErrorAndFatalAlert((__int64)this, 1210,
                                                 -2146893048, 0x2Fu);
              if (WPP_GLOBAL_Control != (CCipherMill *)&WPP_GLOBAL_Control &&
                  (*((_BYTE *)WPP_GLOBAL_Control + 28) & 1) != 0) {
        ...
        PrfHashDetails = -2146893048;
        CSslContext::SetErrorAndFatalAlert((__int64)this, 1210, -2146893048,
                                           0x2Fu);
        if (WPP_GLOBAL_Control != (CCipherMill *)&WPP_GLOBAL_Control &&
            (*((_BYTE *)WPP_GLOBAL_Control + 28) & 1) != 0)
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x44u,

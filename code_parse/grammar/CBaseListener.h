...
public:
  ...
  virtual void enterVcSpecificModifer(CParser::VcSpecificModiferContext * /*ctx*/) override { }
  virtual void exitVcSpecificModifer(CParser::VcSpecificModiferContext * /*ctx*/) override { }

...
__int64 __fastcall CTls13ExtServer::ParsePreSharedKeyExtension(
    CTls13ExtServer *this, unsigned __int8 *a2, unsigned __int16 a3,
    __int64 a4) {
  unsigned int v5;       // ebx
  __int64 v6;            // rcx
  __int16 v7;            // di
  ...
  if (a4) {
    if ((*(_DWORD *)(v6 + 136) & 0x2000000) == 0 ||
        (*(_BYTE *)(a4 + 156) & 0x20) != 0 || !*((_BYTE *)this + 27) ||
      ...
      if (v14 >= 2u) {
        ...
        if (v15 == v14 - 2) {
          ...
          while (1) {
            ...
            v31 = *(_QWORD *)(v29 + 120);
            if (v23 == 32) {
              if (v31 && CSchannelTelemetryContext::
                             m_bTelemetryIsGloballyInitialized) {
                *(_WORD *)(v31 + 64) |= 1u;
                *(_DWORD *)(v31 + 24) = 1;
                v29 = *((_QWORD *)this + 5);
              }
              ...
              v32 = CSessionCacheManager::LookupCacheForServerItem(
                  ...
                  (struct CSslContext *)v29, v22, 0x20u,
              ...
              v32 = CSsl3TlsServerContext::UnprotectAndDeserializeSessionState(
                  (CSsl3TlsServerContext *)v29, v22, v23,
          ...
          LABEL_30:
            if (v32) {
              v5 = CTls13ServerContext::VerifyBinder(
                  *((CTls13ServerContext **)this + 5), v30, v28, v36, v16);
              if (!v5)
                return v5;
              goto LABEL_36;
            }
...
LABEL_36:
  ...
  if (v5 == 315) {
    v5 = -2146893048;
    LOBYTE(a4) = 50;
    CSslContext::SetErrorAndFatalAlert(*((_QWORD *)this + 1), 1202i64,
                                       2148074248i64, a4);
  }
  return v5;
}
// 180078403: variable 'a4' is possibly undefined
// 18005B470: using guessed type __int64 __fastcall
// CSslContext::SetErrorAndFatalAlert(_QWORD, _QWORD, _QWORD, _QWORD);
// 1800927AC: using guessed type bool

...
__int64 __fastcall CTls13ExtServer::ParsePskKeyExchangeModesExtension(
    CTls13ExtServer *this, unsigned __int8 *a2, __int16 a3, __int64 a4) {
  __int16 v5;          // ax
  ...
  LABEL_9:
    if (WPP_GLOBAL_Control != (CCipherMill *)&WPP_GLOBAL_Control &&
      ...
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 14i64,
    ...
    if (WPP_GLOBAL_Control != (CCipherMill *)&WPP_GLOBAL_Control &&
      ...
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 13i64,
              &WPP_5635b40337ae3cd6626e599d778a0aa6_Traceguids);
...
// _QWORD); 18005B470: using guessed type __int64 __fastcall
